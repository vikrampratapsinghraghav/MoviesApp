...
export const getMoviesForCinema = async () => {
  ...
  export const getFlimtrailer = async (film_id:number) => {
    const jsonResult = await hitApi(`https://api-gate2.movieglu.com/trailers/?film_id=${film_id}`);
    console.log('Movie trailer',jsonResult);
